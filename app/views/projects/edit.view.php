...
<div class="col-8 mt-2">
	<div class="card p-4" style="background-color: #fff; border: 0px; border-radius: 8px; box-shadow: 0 4px 5px 0 rgba(0,0,0,0.2);">
		<div class="card-body">
			<?= alert_msg(); ?>

			<form method="POST" action="<?= route("/project/{$project_details['id']}") ?>">
				<?= csrf() ?>
